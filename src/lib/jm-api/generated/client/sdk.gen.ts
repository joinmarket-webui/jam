 ...
 */
export const lockwallet = <ThrowOnError extends boolean = false>(
  options: Options<LockwalletData, ThrowOnError>
) => {
 ...
 * list details of all utxos currently in the wallet.
 */
export const listutxos = <ThrowOnError extends boolean = false>(
  options: Options<ListutxosData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    ListutxosResponses,
    ListutxosErrors,
 ...
 * create and broadcast a transaction (without coinjoin)
 */
export const directsend = <ThrowOnError extends boolean = false>(
  options: Options<DirectsendData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    DirectsendResponses,
    DirectsendErrors,
 ...
 */
export const startmaker = <ThrowOnError extends boolean = false>(
  options: Options<StartmakerData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    StartmakerResponses,
    StartmakerErrors,
 ...
 * stop the yield generator service
 */
export const stopmaker = <ThrowOnError extends boolean = false>(
  options: Options<StopmakerData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    StopmakerResponses,
    StopmakerErrors,
 ...
 * initiate a coinjoin as taker
 */
export const docoinjoin = <ThrowOnError extends boolean = false>(
  options: Options<DocoinjoinData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    DocoinjoinResponses,
    DocoinjoinErrors,
 ...
 */
export const runschedule = <ThrowOnError extends boolean = false>(
  options: Options<RunscheduleData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    RunscheduleResponses,
    RunscheduleErrors,
 ...
 * freeze or unfreeze an individual utxo for spending
 */
export const freeze = <ThrowOnError extends boolean = false>(
  options: Options<FreezeData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).post<
    FreezeResponses,
    FreezeErrors,
 ...
 */
export const getseed = <ThrowOnError extends boolean = false>(
  options: Options<GetseedData, ThrowOnError>
) => {
  return (options.client ?? _heyApiClient).get<
    GetseedResponses,
    GetseedErrors,
