...
export type RecoverwalletResponse =
  RecoverwalletResponses[keyof RecoverwalletResponses];
...
export type UnlockwalletResponse =
  UnlockwalletResponses[keyof UnlockwalletResponses];
...
export type DisplaywalletResponse =
  DisplaywalletResponses[keyof DisplaywalletResponses];
...
export type YieldgenreportError =
  YieldgenreportErrors[keyof YieldgenreportErrors];
...
export type YieldgenreportResponse =
  YieldgenreportResponses[keyof YieldgenreportResponses];
...
export type RescanblockchainError =
  RescanblockchainErrors[keyof RescanblockchainErrors];
...
export type RescanblockchainResponse =
  RescanblockchainResponses[keyof RescanblockchainResponses];
...
export type GetrescaninfoResponse =
  GetrescaninfoResponses[keyof GetrescaninfoResponses];
...
export type GettimelockaddressError =
  GettimelockaddressErrors[keyof GettimelockaddressErrors];
...
export type GettimelockaddressResponse =
  GettimelockaddressResponses[keyof GettimelockaddressResponses];
...
export type RunscheduleResponse =
  RunscheduleResponses[keyof RunscheduleResponses];
...
export type ConfigsettingResponse =
  ConfigsettingResponses[keyof ConfigsettingResponses];
