...
export const JAM_API_AUTH_TOKEN_RENEW_SAFETY_FACTOR: Factor = percentageToFactor(75)
export const JAM_API_AUTH_TOKEN_RENEW_MIN_INTERVAL: Milliseconds = 1_000
export const JAM_API_AUTH_TOKEN_RENEW_INTERVAL: Milliseconds = Math.round(
  JM_API_AUTH_TOKEN_EXPIRY * JAM_API_AUTH_TOKEN_RENEW_SAFETY_FACTOR,
)
