import { displaywalletOptions } from '@joinmarket-ng/joinmarket-ng-api-ts/@tanstack/react-query'
import type { DisplaywalletResponse, WalletDisplayResponse } from '@joinmarket-ng/joinmarket-ng-api-ts/jm'
