import { versionOptions } from '@joinmarket-ng/joinmarket-ng-api-ts/@tanstack/react-query'
import type { VersionResponse } from '@joinmarket-ng/joinmarket-ng-api-ts/jm'
