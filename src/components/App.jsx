...
import { FidelityBondAdvanced } from './FidelityBondAdvanced'
              ...
              <Route element={<Layout />}>
                ...
                {currentWallet && (
                  <>
                    ...
                    {isFeatureEnabled('fidelityBondsAdvanced') && (
                      <Route path={routes.fidelityBondsAdvanced} element={<FidelityBondAdvanced />} />
                    )}
                  </>
                )}
              </Route>
