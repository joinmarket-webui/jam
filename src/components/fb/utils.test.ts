...
describe('utils', () => {
  describe('lockdate', () => {
    it('should convert timestamp to lockdate', () => {
      ...
      expect(() => fb.lockdate.fromTimestamp(NaN)).toThrow('Unsupported input: NaN')
    })
    ...
    it('should convert lockdate to timestamp', () => {
      ...
      expect(() => fb.lockdate.toTimestamp('-1' as Lockdate)).toThrow('Unsupported format')
      expect(() => fb.lockdate.toTimestamp('2008-1' as Lockdate)).toThrow('Unsupported format')
      expect(() => fb.lockdate.toTimestamp('10000-01' as Lockdate)).toThrow('Unsupported format')
      expect(() => fb.lockdate.toTimestamp('' as Lockdate)).toThrow('Unsupported format')
      expect(() => fb.lockdate.toTimestamp('any' as Lockdate)).toThrow('Unsupported format')
    })
