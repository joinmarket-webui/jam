...
import { startmakerMutation, stopmakerOptions } from '@joinmarket-ng/joinmarket-ng-api-ts/@tanstack/react-query'
import type { StartMakerRequest } from '@joinmarket-ng/joinmarket-ng-api-ts/jm'
