  ...
  return (
    <div className={cn('flex flex-col gap-4', className)}>
      ...
      <Field data-invalid={errors.maxCjFeeAbs !== undefined}>
        ...
        {errors.maxCjFeeAbs?.message && <FieldError>{errors.maxCjFeeAbs.message}</FieldError>}
      </Field>
      ...
      <Field data-invalid={errors.maxCjFeeRelInPercent !== undefined}>
        ...
        {errors.maxCjFeeRelInPercent?.message && <FieldError>{errors.maxCjFeeRelInPercent.message}</FieldError>}
      </Field>
    </div>
  )
}
